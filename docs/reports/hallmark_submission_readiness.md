...
- Official row file: `/Users/sebastianboehler/Documents/GitHub/hallmark-mlx/artifacts/official_eval_sharded_fast5/dev_public_bibtex_first_fallback/merged/row.json`
- Official result file: `/Users/sebastianboehler/Documents/GitHub/hallmark-mlx/artifacts/official_eval_sharded_fast5/dev_public_bibtex_first_fallback/merged/result.json`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | hallmark-mlx | HYBRID | 0.947 | 0.942 | 0.946 | 0.129 | 0.064 | executed_here |
...
- Our row: DR 0.947, F1-H 0.942, TW-F1 0.946, FPR 0.129, ECE 0.064.
...
- Full metrics from `result.json`: AUROC 0.915, AUPRC 0.932, MCC 0.823, mean API calls 0.665.
