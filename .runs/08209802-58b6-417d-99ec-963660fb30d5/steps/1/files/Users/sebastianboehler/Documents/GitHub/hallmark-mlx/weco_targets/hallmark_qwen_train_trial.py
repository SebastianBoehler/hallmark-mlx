...
TRIAL_OVERRIDES = {
    ...
    "training": {
        # increase capacity and iterations moderately for a short LoRA run
        "num_layers": 14,
    ...
    "tools": {
        # keep the same tool set but tighten rows to encourage concise, higher-precision retrieval
    ...
    "eval": {
        # emphasize frontier performance at low tool-call budgets (focus on 1-2 calls)
        "tool_call_budgets": [1, 2],
    },
}
