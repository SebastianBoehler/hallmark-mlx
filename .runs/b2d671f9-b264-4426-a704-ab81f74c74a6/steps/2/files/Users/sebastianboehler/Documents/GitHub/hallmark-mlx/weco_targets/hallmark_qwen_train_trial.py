...
TRIAL_OVERRIDES = {
    ...
    "training": {
        # Explore a slightly deeper LoRA with larger context but keep run short
        "num_layers": 16,
    ...
    "tools": {
        # Keep the same toolset but reduce rows to encourage 1-2 calls and faster resolution
